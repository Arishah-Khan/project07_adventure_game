...
const healthPotionDropChance = 30; // Percentage
let running = true;
...
async function gameLoop() {
    ...
    while (running && health > 0) {
        ...
        const enemy = chalk.redBright(enemyChoice.enemy);
        ...
        while (enemyHealth > 0 && health > 0) {
            ...
            switch (control.command) {
                case "Attack":
                    const strikeDamage = getRandomNumber(1, attackDamage);
                    const damageTaken = getRandomNumber(1, enemyAttackDamage);
                    health -= damageTaken;
